...
git clone %THIS_GIT_CONFIG% --branch %THIS_OSP_BRANCH% https://github.com/wolfssl/osp.git %THIS_CLONE_DEPTH%
if %ERRORLEVEL% neq 0 goto ERROR
...
:REALM_FETCH
    ...
    git apply ../../../realm-commit-5533505d1.patch
    if !ERRORLEVEL! neq 0 goto ERROR
